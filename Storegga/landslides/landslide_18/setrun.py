...
tauy_i = 15000.0       # initial yield strength (Pa)
tauy_r = 3000.0       # residual yield strength (Pa)
remold_coeff = 5.e-3  # remolding parameter

#Initial Conditioin
qinit_style = 1       # topotype style initial conditions
...
#------------------------------
    ...
    clawdata.num_cells[0] = 9*30*3/2
    clawdata.num_cells[1] = 5*30*3/2
    ...
    if clawdata.output_style==1:
        ...
        clawdata.tfinal = 60.*60.*8
        clawdata.output_t0 = True  # output at initial (or restart) time?
        
    elif clawdata.output_style == 2:
        # Specify a list or numpy array of output times:
        # Include t0 if you want output at the initial time.
        clawdata.output_times = [0.,60.*60.*6.01]
...
#-------------------
    ...
    #fname = '/media/jihwan/jik/Topo/etopo1/E10W30S50N75.asc'
    ...
    #fixedgrids.append([0.,3600.*6,361,-4.,6.,62,67,10*30+1,5*30+1,0,0])
