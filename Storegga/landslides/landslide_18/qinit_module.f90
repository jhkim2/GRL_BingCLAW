...
contains
    ...
    subroutine read_qinit(fname)
        ...
        call read_topo_header(fname,qinit_style,mx_qinit,my_qinit, &
                 x_low_qinit,y_low_qinit,x_hi_qinit,y_hi_qinit,dx_qinit,dy_qinit)

        allocate(qinit(mx_qinit*my_qinit))

        call read_topo_file(mx_qinit,my_qinit,qinit_style,fname,qinit)
