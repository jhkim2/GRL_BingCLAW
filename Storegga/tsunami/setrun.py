...
#------------------------------
    ...
    clawdata.num_cells[0] = 35*1
    clawdata.num_cells[1] = 18*1
    ...
    amrdata.refinement_ratios_x = [5,6,2]
    amrdata.refinement_ratios_y = [5,6,2]
    amrdata.refinement_ratios_t = [5,6,2]
    ...
    rundata.regiondata.regions.append([1, 1, 0., 1.e10, -180.,180.,-90,90.])
    rundata.regiondata.regions.append([1, 3, 0., 1.e10, -7, 12., 55,90.])
    rundata.regiondata.regions.append([1, 3, 0., 1.e10, 12, 25., 67,90.])
    rundata.regiondata.regions.append([3, 3, 0., 3600.*4., -6, 6, 63, 69])
    rundata.regiondata.regions.append([1, 4, 0., 1.e10, -7.,-5.,61,63])
    rundata.regiondata.regions.append([1, 4, 0., 1.e10, -3.,0.,60,62])
    rundata.regiondata.regions.append([1, 4, 0., 1.e10, -5.,-3.,58,60])
    rundata.regiondata.regions.append([1, 4, 0., 1.e10, 4.,8.,60,63])
    rundata.regiondata.regions.append([1, 4, 0., 1.e10, 8.,11.,63,65])
    rundata.regiondata.regions.append([1, 4, 0., 1.e10, 23.,28.,70.5,72])
    rundata.regiondata.regions.append([1, 4, 0., 1.e10, 7.,9.,55.,57.])
    ...
    rundata.gaugedata.gauges.append([38, 7.5, 57., 0., 1.e10])  #Denmark
    rundata.gaugedata.gauges.append([39, 6.5 , 56.15, 0., 1.e10])  #Denmark
    rundata.gaugedata.gauges.append([40, 7. , 55.9, 0., 1.e10])  #Denmark
...
#-------------------
    ...
    #fname = '/media/jihwan/jik/Topo/etopo1/E30W30S50N75.asc'
    fname = '../landslides/landslide_16/slide_eta_0m.tt3'
    topo_data.topofiles.append([3, 1, 3, 0., 1.e10, fname])
    fname = '/media/jihwan/jik/Topo/etopo1/E15E30S50N75.asc'
    topo_data.topofiles.append([3, 1, 3, 0., 1.e10, fname])
    fname = '/media/jihwan/jik/Topo/etopo1/W30E30S70N75.asc'
    topo_data.topofiles.append([3, 1, 3, 0., 1.e10, fname])
    fname = '/media/jihwan/jik/Topo/etopo1/W15E25S45N55.asc'
    topo_data.topofiles.append([3, 1, 3, 0., 1.e10, fname])
    ...
    dtopo_path = '/media/jihwan/jik/work/ngi/fvm/Bing_Case_Studies/Storegga/landslide/_topo/dtopo_storegga_10kto500_case6.tt3'
    dtopo_path = '../landslide/dtopo_storegga_10kto500.tt3'
