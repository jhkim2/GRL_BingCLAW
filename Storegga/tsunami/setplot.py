...
#--------------------------
    ...
    plotitem.pcolor_cmin = sea_level-5.
    plotitem.pcolor_cmax = sea_level+5.
    ...
    # Figure for surface
    #-----------------------------------------
    plotfigure = plotdata.new_plotfigure(name='Zoom1', figno=1)
    ...
    plotitem.amr_celledges_show = [0,0,0]
    plotitem.patchedges_show = 0
    plotaxes.xlimits = [23,26]
    plotaxes.ylimits = [70.5,71.5]

    # add contour lines of bathy if desired:
    plotitem = plotaxes.new_plotitem(plot_type='2d_contour')
    plotitem.show = True
    plotitem.plot_var = geoplot.topo
    plotitem.contour_levels = (-12,-2,8,12)
    plotitem.amr_contour_colors = ['y']  # color on each level
    plotitem.kwargs = {'linestyles':'solid','linewidths':1}
    plotitem.amr_contour_show = [0,0,0,0]  
    plotitem.celledges_show = 0
    plotitem.patchedges_show = 0
