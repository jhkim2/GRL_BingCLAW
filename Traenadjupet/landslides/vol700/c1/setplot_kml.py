...
#--------------------------
    ...
    #-----------------------------------------
    plotdata.kml_name = "Traenadjupet_slide"
    plotdata.kml_starttime = [2020,1,1,0,0,0]  # Time of event in UTC [None]
    plotdata.kml_tz_offset = -1    # Time zone offset (in hours) of event. [None]

    plotdata.kml_index_fname = "Traenadjupet_slide"  # name for .kmz and .kml files ["_GoogleEarth"]
    ...
    plotfigure.kml_xlimits = [6,11]
    plotfigure.kml_ylimits = [67, 70.];
