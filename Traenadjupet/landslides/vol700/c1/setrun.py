...
#------------------------------
    ...
    clawdata.num_cells[0] = 5*60*1
    clawdata.num_cells[1] = 3*60*1
    ...
    if clawdata.output_style==1:
        ...
        clawdata.num_output_times = 60*4
        clawdata.tfinal = 60.*60.*4
...
#-------------------
    ...
    fname = '/media/jihwan/jik/Topo/Storegga/etopo1w0e15n75s65.asc'
    topofiles.append([3, 1, 1, 0., 1.e10, fname])
